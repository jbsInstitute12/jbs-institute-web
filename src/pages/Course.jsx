                        ...
                        <div className='p40-y bg-fourth'>
                            <div className="container">
                                <div className="row course-item">
                                    <div className="item col-xxl-3 col-lg-3 col-md-3  col-sm-6  col-smm-6 m20-bottom" id="Programming">
                                        <DurationBox icon={`fa-solid fa-book`} text={`Programming`} />
                                    </div>
                                    <div className="item col-xxl-3 col-lg-3 col-md-3  col-sm-6  col-smm-6 m20-bottom" id="Project training">
                                        <DurationBox icon={`fa-solid fa-book`} text={`Project training`} />
                                    </div>
                                    <div className="item col-xxl-3 col-lg-3 col-md-3  col-sm-6  col-smm-6 m20-bottom" id="Frontend Coding">
                                        <DurationBox icon={`fa-solid fa-book`} text={`Frontend Coding`} />
                                    </div>
                                    <div className="item col-xxl-3 col-lg-3 col-md-3  col-sm-6  col-smm-6 m20-bottom" id="Graphics Design    ">
                                        <DurationBox icon={`fa-solid fa-book`} text={`Graphics Design`} />
                                    </div>
                                </div>
                            </div>
                        </div>
...
export const DurationBox = ({ icon, text }) => {
    return (
        <div className="mainDurationBox">
            ...
            <div className="durationText fs-lg-18 fs-md-16 fs-12 text-overflow-1" style={{ color: '#d46615' }}>{text}</div>
        </div>
    )
};
