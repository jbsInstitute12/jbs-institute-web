              ...
              <div className="col-lg-8 mb-4">
                ...
                <div className="Master_course_desc">
                  <p className="mb-2">
                    ...
                    Bjarne Stroustrup in a1979 in Bell labs. C++ has become one
                    of the popular languages. And to build a career in this
                    field is easy. To become a professional and expert in coding
                    one must get the training from the right institute. Jbs It
                    Institute Institute is the best C++ Training in surat.
                    Learning C++, a programmer or individual can create an
                    application which will run on a wide variety of hardware
                    platforms like windows, Linux, Unix, and Mac operating
                    system. C++ is the most powerful programming language that
                    exists today.
                  </p>

                  <p className="mb-2">
                    c++ Training-Student will learn and become an expert on C++
                    syntax, C++ language fundamentals, create functions on C++
                    to building blocks of learning the C computer programming
                    languages. C++ can do many things that other languages
                    can’t. C++ ranks 4th according to IEEE's top programming
                    languages in 2017. For student learning, C ++ is the best
