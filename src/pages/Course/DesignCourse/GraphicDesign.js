                  ...
                  <div class="ps-3">
                    <ul class="course-points">
                      <li class="text-dark bullet-heading">
                        Introduction to graphic design and knowing the history
                      </li>
                      ...
                      <li>
                        ...
                        graphics like branding, logos, business cards, Flyers,
                        brochures, magazines, ad graphics, social media &
                        business posts, packaging, portfolio presentations, and
                        many projects
                      </li>
                      <li>
                  ...
                  <div class="faq-item mb-3">
                    ...
                    <div class="faq-body">
                      <ul class="bullets-point ps-3 fs-14">
                        ...
                        <li>
                          Students of any stream of science, commerce or arts
                        </li>
                  ...
                  <div class="faq-item mb-3">
                    ...
                    <div class="faq-body">
                      <ul class="bullets-point ps-3 fs-14">
                        ...
                        <li>
                          You can learn web designing and we are offering web
