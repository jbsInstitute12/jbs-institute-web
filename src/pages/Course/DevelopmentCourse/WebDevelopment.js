            ...
            <div className="row">
              <div className="col-lg-8 mb-4">
                ...
                <div className="Master_course_desc">
                  ...
                  for the Internet or an Internet. Web development can range
                  from a simple single static page of plain text to complex web
                ...
                <div class="accordion accordion-flush" id="faqlist">
                  ...
                  >
                    ...
                    >
                      Master in Web Back end Developing
                    </h4>
                    <div>
                      <ul class="course-points_1">
                        ...
                        <div
                          ...
                          data-bs-parent="#faqlist"
                        >
                          <li>Introduction of PHP & PHP MySQL server</li>
                          ...
                          <li>
                            Manage Admin Panel with Database using OOPS Concept
                          </li>
                      ...
                      <ul class="course-points_1 my-3">
                        ...
                        >
                          ...
                          <li>
                            ECMAScript & Versions & Install Environment Scratch
                            JS
                          </li>
                          <li>
                          ...
                          <li>
                            Working with JSON (JSON.parse, JSON.stringify, JSON
                            object, JSON array)
                          </li>
                          <li>
                      ...
                      <ul class="course-points_1 my-3">
                        ...
                        >
                          <li>
                            Understanding Developer Tools And Setup Node Js
                            Environment
                          </li>
                          <li>Installing NPM (Globally & Locally)</li>
                          <li>Understanding Event Emitter & REPL and CMD</li>
                          <li>
                            Make server with node js and Handle HTTP REQUEST and
                            RESPONSE.
                          </li>
                          <li>
                            How to attach server Static Resources & Middleware &
                            File Streaming
                          </li>
                          <li>
                            Different Types of Web Application Frameworks
                            (Express, Koa, Hapi, Others)
                          </li>
                          <li>Understanding MVC Framework Express JS</li>
                          <li>Setup MongoDB and Connect with Nodejs</li>
                          <li>
                            Callback Functionality (Promises and Bluebird
                            Promises)
                          </li>
                          <li>
                            Working with Different Type Module (Node Mailer,
                            PDFMAKE, Passport JS, Express-session, Cookie
                            Parser, connect-flash)
                          </li>
                          <li>
                            Installing Passport js and making Manual
                            Authentication
                          </li>
                          <li>
                          ...
                          <li>
                            Rest full API (Social Media Integration – Google,
                            Facebook)
                          </li>
                      ...
                      <div class="border p-2 px-3 rounded d-inline-block">
                        ...
                        <p class="fs-14 mb-3 text=muted">
                          MY SQL, AJAX, JQuery, Live Portfolio Marketing, PHP
                          Core or Javascript, Framework (Node js. Or Laravel)
                          PD, Entrepreneur & Freelancing
                        </p>
                    ...
                    >
                      <div class="ps-3">
                        <p className="text-muted fs-14">
                          Web development is the phase after web designing; even
                          after the design of your business website is ready,
                          still, If your business needs a digital platform, you
                          must develop a website. Some developers create it and
                          make this website functional. In a concise form, web
                          development and web designing rely on each other,
                          which is equally crucial for your successful business.
                          You can enroll for{" "}
                          <a href="https://www.rnwmultimedia.edu.in/game-design-development-course-surat.php">
                            Game Design Course in Surat
                          </a>
                          . This course can be done by anyone from standard 10th
                          pass out to postgraduate degree holders and those who
                          are graduating in the field of media for them, and it
                          is likely to be a very important subject. For this
                          field, there are lots of opportunities in software
                          companies.
                        </p>
                        <p className="text-muted fs-14 mb-4">
                          In web development, every website function is
                          developed according to its task, which can then be
                          used in surfing the web. The web developer needs to be
                          a website owner, so there is a high demand for web
                          developers in this decade and the future. Thus this
                          course can also be considered a canonical skill
                          enhancement that allows students to increase their
                          technical skills. We are also offering aweb design
                          course in Surat you can get more details on our
                          website.
                        </p>
                      </div>
                    </div>
                  ...
                  <div class="course-faq mt-5">
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-3 mb-3 fs-14">
                            ...
                            <li>
                              A person interested in learning about logical
                              things
                            </li>
                            <li>Web Designer who wants to learn to program</li>
                            <li>
                              Individuals who want to become software
                              developers.
                            </li>
                            <li>
                              A person who wants to pursue higher studies in IT
                              or go abroad for a job.
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-3 mb-3 fs-14">
                            ...
                            <li>
                              Most of the work is done by using websites and the
                              internet.
                            </li>
                          </ul>
                        </div>
                    ...
                    <div class="faq-item mb-4">
                      <h4 class=" accordion-header alert-dark p-2 fs-16 rounded ps-3">
                        ...
                        >
                          What after the Web Development course?
                        </button>
                      </h4>
                      <div
                        id="faq-content-9"
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-3 mb-3 fs-14">
                            <li>
                              Huge scope to get a job as a Web Developer in
                              Multinational IT Companies
                            </li>
                            <li>
                              You can start up your company with a minimum
                              investment.
                            </li>
                          </ul>
                        </div>
