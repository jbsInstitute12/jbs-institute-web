            ...
            <div className="row">
              <div className="col-lg-8 mb-4">
                ...
                <div className="Master_course_desc">
                  Jbs It Institute are one of Surat's most trusted and oldest
                  Full stack development training institutes. Here full stack
                  classes are conducted by those faculties who have been part of
                  industries and worked on various projects. The Jbs It
                  Institute ensures every student is fully trained and capable
                  of being a full stack expert. Once the training course is
                  completed, Institute also provides they are placed on the best
                  <Link to="/fullstackdevelopment" style={{ color: "#3f78e0" }}>
                ...
                <div className="Master_course_btn mb-4 ">
                  <button className="rounded text-center p-2 px-3 fs-16">
                    Course Duration{" "}
                    <span style={{ color: "##343f52" }}>15 Months</span>
                  </button>
                  <button className="rounded text-center p-2 px-3 fs-16">
                    Daily Time{" "}
                ...
                <div class="accordion accordion-flush" id="faqlist">
                  <div
                    id="web-front-coding"
                    class="course-description pt-2 mt-3"
                  >
                    <h4
                    ...
                    <div>
                      ...
                      <div class="border p-2 px-3 rounded d-inline-block">
                        ...
                        <p className="my-4 text-muted fs-16">
                    ...
                    <div>
                      <ul class="course-points_1">
                        ...
                        >
                          ...
                          <li>
                            Understanding Class and (Objects, constructor,
                    ...
                    <div>
                      <ul class="course-points_1">
                        ...
                        >
                          ...
                          <li id="reactjs">
                            Experience (Class and Objects, constructor,
                            Prototype, Inheritance)
                          </li>
                          <li>
                            Working with JavaScript DOM ( Document Object Module
                      ...
                      <ul class="course-points_1">
                        ...
                        >
                          ...
                          <li>
                            ...
                            PDFMAKE, Socket0, Passport JS, Express-session,
                      ...
                      <ul class="course-points_1">
                        ...
                        >
                          ...
                          <li>
                            Generate Token (JWT) (Crud
                            Operation)(GET,POST,DELETE,PUT,PATCH)
                          </li>
                        </div>
                      </ul>

                      <div class="border p-2 px-3 mb-3 rounded d-inline-block">
                        <h6 class="text-dark my-3 fs-15" id="Mongodb">
                          LANGUAGES TO LEARN:
                        </h6>
                        <p class="fs-14 mb-2">
                    ...
                    <div class="text-center">
                      <div class="border p-3 rounded d-inline-block mt-5 text-center">
                        ...
                        <div class="d-flex flex-wrap mt-3">
                          ...
                          <h4 class="text-center alert-dark p-2 fs-15  text-muted rounded ps-3 ">
                    ...
                    <div class="faq-item">
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-3 mb-4  fs-15 ">
                            <li>
                              You can master all the techniques involved in a
                              development project.
                            </li>
                            ...
                            <li>
                              You can reduce the time used for team
                              communication.
                            </li>
                            <li>
                              You can switch between front and back-end
                              development based on requirements.
                            </li>
                            <li>
                              You can better understand all aspects of new and
