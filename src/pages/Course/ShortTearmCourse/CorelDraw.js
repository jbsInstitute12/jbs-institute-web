                        ...
                        <div className="row">
                            <div className="col-lg-8 mb-2">
                                <div className="Master_couse_title">
                                    About <span style={{ color: '#D46615' }}>CorelDraw</span>
                                </div>
                                <div className="Master_course_desc">
                                    <p className="mb-2">
                                        ...
                                        Photoshop can do nearly anything online media. It started out as a photo processing program. Now it has developed to create and edit video,
                                        create 3-D images and graphic designs.
                                    </p>
                                </div>
                                    ...
                                    <div class="faq-item mb-3">
                                        ...
                                        <div class="faq-body">
                                            <ul class="bullets-point ps-3 fs-14">
                                                ...
                                                <li class="pb-2">Introduction of RGB &amp; CYMK Color</li>
                                    ...
                                    <div class="faq-item mb-3">
                                        ...
                                        <div class="faq-body">
                                            <ul class="bullets-point ps-3 fs-14">
                                                ...
                                                <li class="pb-2">Pressing Shapes In To Leather Work</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="faq-item mb-3">
